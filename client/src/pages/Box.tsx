  ...
  const translations = {
    nl: {
      ...
      servicesSection: {
        ...
        waxing: "BIAB",
        waxingDesc: "",
        newAcryl: "Gellak voeten",
        newAcrylDesc: "----",
        fillAcryl: "Gellak handen",
        fillAcrylDesc: "----",
        ombreFrench: "Gellak French",
        ombreFrenchDesc: "----",
        pedicureShellac: "Gellak verwijderen",
        pedicureShellacDesc: "----",
        manicureShellac: "Gellak verwijderen +opnieuw",
        manicureShellacDesc: "----",
        specialPackage: "Speciale Pakketdeal",
        specialDesc: "Krijg een volledige manicure + pedicure combo voor de beste waarde!",
        bookSave: "Boek Nu & Bespaar €"
      },
      gallery: {
        title: "ONZE GALERIJ",
        creative: "Title",
